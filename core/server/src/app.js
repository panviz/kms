...
import * as Raw from '@graphiy/provider-raw'
import { pluralize } from '@graphiy/util'
...
export default class Self {
  ...
  findNodesByTags (p) {
    return new Promise((resolve, reject) => {
      ...
      const tagsAnd = pluralize(args.tagsAnd)
      const tagsOr = pluralize(args.tagsOr)
  ...
  getGraph (context, depth = 1) {
    const contextS = pluralize(context)
